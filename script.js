...
function init() {
    ...
    camera = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 0.1, 1000); // Increase FOV to 90

    // Adjust the camera position and rotation
    camera.position.set(0, -20, 0); // Move the camera further back and higher
